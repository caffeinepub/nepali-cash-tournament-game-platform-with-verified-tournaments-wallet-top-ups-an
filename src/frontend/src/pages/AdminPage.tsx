      ...
      <div className="space-y-6">
        ...
        <Tabs defaultValue="tournaments" className="w-full">
          <TabsList className="grid w-full grid-cols-2 lg:grid-cols-4">
            <TabsTrigger value="tournaments">प्रतियोगिताहरू</TabsTrigger>
            <TabsTrigger value="verify">प्रमाणित गर्नुहोस्</TabsTrigger>
            <TabsTrigger value="topups">टप अप</TabsTrigger>
            <TabsTrigger value="withdrawals">निकासी</TabsTrigger>
          </TabsList>
